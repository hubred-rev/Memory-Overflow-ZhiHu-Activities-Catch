...
```
cd existing_repo
git remote add origin https://gitlab.com/ProletRevDictas/zhihu-activities-catch.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ProletRevDictas/zhihu-activities-catch/-/settings/integrations)
